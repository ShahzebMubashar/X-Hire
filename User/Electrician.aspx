<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Electrician.aspx.cs" Inherits="ProjectDB.User.Electrician" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600&display=swap">
    <link rel="stylesheet" href="..\XHire\public\electrician.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <header class="hero">
        ...
        <div class="text_container">
            <div class="lefttext">
                <h1>Expert Electricians Powering Your Home Safely</h1>
                <br>
                <p>Trust our skilled electricians for safe, reliable solutions. From installations to repairs, we light up your home with amazing expertise.</p>
            </div>
            ...
            <div class="righttext2">
                ...
                <h4>Damage Repair</h4>
                <p>Secure your space. Expert electrician service at an affordable price.</p>
            </div>
        </div>
    </header>
            ...
            <div class="features-container">
                <div class="feature">
                    <div class="feature-content">
                        ...
                        <h3 style="text-align: center; font-size: 35px;">7 Minutes</h3>
                ...
                <div class="feature">
                    <div class="feature-content">
                        ...
                        <h3 style="text-align: center; font-size: 35px;">2,934</h3>
                ...
                <div class="feature">
                    <div class="feature-content">
                        ...
                        <h3 style="text-align: center; font-size: 35px;">90.4</h3>
                ...
                <div class="feature">
                    <div class="feature-content">
                        ...
                        <h3 style="text-align: center; font-size: 35px;">1,125</h3>
            ...
            <div class="newpost">
                ...
                <div class="newpost-content">
                    <div class="newpost-details">
                        ...
                        <p>Hey there! I'm Dylan, a seasoned painter with over a decade of experience in transforming spaces. From elegant door paints to intricate wall textures, I specialize in bringing your vision to life. Let's craft your dream home with meticulous attention to detail and a touch of artistic flair!</p>
        ...
        <div class="newpostcontainer">
            <div class="newpost">
                ...
                <div class="newpost-content">
                    <div class="newpost-details">
                        <h3>Mike Steven</h3>
                        <p>Hello, I'm Mike, your go-to expert for door polish perfection. With a knack for enhancing wooden surfaces, I'll give your doors a glossy finish that radiates elegance. Trust me to bring out the natural beauty of your home's entrance.</p>
                        <div class="ratings-orders">
        ...
        <div class="newpostcontainer">
            <div class="newpost">
                ...
                <div class="newpost-content">
                    <div class="newpost-details">
                        <h3>Alex Artistry</h3>
                        <p>Hi, I'm Alex, dedicated to painting windows that illuminate your space. With a blend of precision and creativity, I'll adorn your windows with vibrant hues, creating a picturesque view both inside and out. Let's add a splash of color to your home's charm!</p>
                        <div class="ratings-orders">
        ...
        <div class="newpostcontainer">
            <div class="newpost">
                ...
                <div class="newpost-content">
                    <div class="newpost-details">
                        <h3>Olivia Paints</h3>
                        <p>Hi there! I'm Olivia, passionate about adding a pop of color to your walls. With expertise in interior painting, I'll transform your living space into a vibrant sanctuary. Let's infuse personality and warmth into your home with a palette that speaks to you!</p>
                        <div class="ratings-orders">
        ...
        <div class="newpostcontainer">
            <div class="newpost">
                ...
                <div class="newpost-content">
                    <div class="newpost-details">
                        <h3>Ryan Paints</h3>
                        <p>Hey, I'm Ryan, dedicated to transforming your walls into works of art. With meticulous attention to detail, I'll create captivating designs that reflect your style and personality. Let's turn your home into a masterpiece!</p>
                        <div class="ratings-orders">
        ...
        <div class="newpostcontainer">
            <div class="newpost">
                ...
                <div class="newpost-content">
                    <div class="newpost-details">
                        <h3>Chris Paints</h3>
                        <p>Hello, I'm Chris, your expert in exterior painting. With a focus on durability and aesthetics, I'll protect and beautify your home's exterior surfaces. Let's enhance curb appeal and make a lasting impression!</p>
                        <div class="ratings-orders">
