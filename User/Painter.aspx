<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Painter.aspx.cs" Inherits="ProjectDB.User.Painter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <head>
        ...
        <title>X-HIRE</title>
        <link rel="stylesheet" href="..\XHire\public\stylepainter.css">
        ...
        <form id="form1">
            ...
            <header class="hero">
                ...
                <div class="text_container">
                    <div class="lefttext">
                        <h1>Revitalize Your Home with Expert Painting Services</h1>
                        <br>
                        <p>
                            Transform your space with expert painting services<br>
                            from X-Hire. Let our skilled painters revitalize your<br>
                            home with a professional touch and precision.
                        </p>
                    </div>

                    <div class="righttext1">
                        <h3>2 Months Contract</h3>
                        <h4>Home Decoration</h4>
                        <p>Secure your space. Expert painting service at an affordable price.</p>
                    </div>
                    ...
                    <div class="righttext2">
                        ...
                        <h4>Home Decoration</h4>
                        <p>
                            Secure your space. Expert painting<br>
                    ...
                    <div class="features-container">
                        <div class="feature">
                            ...
                            <div class="feature-content">
                                ...
                                <h3 style="text-align: center; font-size: 35px;">12 Minutes</h3>
                        ...
                        <div class="feature">
                            ...
                            <div class="feature-content">
                                ...
                                <h3 style="text-align: center; font-size: 35px;">3,104</h3>
                        ...
                        <div class="feature">
                            ...
                            <div class="feature-content">
                                ...
                                <h3 style="text-align: center; font-size: 35px;">89.2</h3>
                        ...
                        <div class="feature">
                            ...
                            <div class="feature-content">
                                ...
                                <h3 style="text-align: center; font-size: 35px;">1,762</h3>
            ...
            <h1 class="newposth1">Painter Services</h1>
